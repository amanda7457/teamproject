        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ShippingID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ShippingFirst = table.Column<decimal>(nullable: false),
                    ShippingAdditional = table.Column<decimal>(nullable: false),
                    ManagerSetId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShippingPrices", x => x.ShippingID);
                    table.ForeignKey(
                        name: "FK_ShippingPrices_AspNetUsers_ManagerSetId",
                        column: x => x.ManagerSetId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderShipping = table.Column<decimal>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_ShippingPrices_ShippingID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShippingPrices_ManagerSetId",
